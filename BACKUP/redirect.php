...
<html lang="en">
    <head>
        ...
        <title>sls intranet v1.0.1</title>
        <!-- Favicon-->
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    <div class="container-fluid">
                        <button class="btn btn-primary" id="sidebarToggle">Toggle Navigation</button>
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										...
										<a class="dropdown-item" href="https://slsgaming.net" target="_blank" rel="noopener noreferrer">slsgaming.net</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
